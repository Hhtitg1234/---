...
while a == False:
    ...
    if p == 'кпд':
        ...
        print(
            "2) если не хотите вписывать названия вручную, можно их копировать(зависит от программы, которую вы "
            "используете)")
        print(
            "3) в местах, где есть списки с цифрами, есть запятые, при записи цифр не нужно писать запятые и единицы "
            "измерения")
        print(
            "4) по всем неполадкам или предложениям с добавлением новых функций можно писать сюда: "
            "maximpetrov2806@gmail.com")
        print()
